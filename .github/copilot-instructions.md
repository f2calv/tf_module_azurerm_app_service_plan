...
This repository publishes a single reusable Terraform child module that provisions an Azure App Service plan for hosting web applications and function apps.
